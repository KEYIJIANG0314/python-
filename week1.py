...
>>> r.headers
{'Connection': 'close', 'Transfer-Encoding': 'chunked', 'Cache-Control': 'private, no-cache, no-store, proxy-revalidate, no-transform', 'Content-Encoding': 'gzip', 'Content-Type': 'text/html', 'Date': 'Tue, 28 Jul 2020 02:21:16 GMT', 'Last-Modified': 'Mon, 23 Jan 2017 13:27:36 GMT', 'Pragma': 'no-cache', 'Server': 'bfe/1.0.8.18', 'Set-Cookie': 'BDORZ=27315; max-age=86400; domain=.baidu.com; path=/'}
>>> r.context
Traceback (most recent call last):
...
>>> r.encoding
'utf-8'
>>> r = requests_get("http://www.baidu.com")
Traceback (most recent call last):
